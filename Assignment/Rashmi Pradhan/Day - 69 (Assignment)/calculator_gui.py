...
display = Entry(root, textvariable=data, bd=29, justify="right", bg="grey", font=("ariel", 20))
...
btn_eqal = Button(root, text="=", font=("ariel", 12, "bold"), bd=12, height=2, width=6, command=btnEqual)
btn_eqal.grid(row=4, column=3)
